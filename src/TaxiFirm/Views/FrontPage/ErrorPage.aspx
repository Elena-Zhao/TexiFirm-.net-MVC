...
<ul class="menu" id="responsive">
	...
	<li><a href="#"><i class="halflings white file"></i> 新闻</a>
		<!-- Mega Menu / Start -->
		<ul class="cols2">
			<li class="col2">
				<h4>两个模块</h4>
	...
	<li><a href="#"><i class="halflings white cog"></i> 论坛</a>
		<!-- Second Level / Start -->
		<ul>
			<li><a href="#">论坛模块</a></li>
			<li><a href="#">论坛评论</a></li>
	...
	<li><a href="#"><i class="halflings white briefcase"></i> 画廊</a>
	</li>


	<li><a href="#"><i class="halflings white pencil"></i> 其他</a>
	</li>

	<li><a href="#"><i class="halflings white envelope"></i> 联系我们</a>
    </li>
